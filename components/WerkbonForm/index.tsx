          ...
          <div className="flex flex-col gap-2">
            ...
            {form.parts.filter(p => !p.toOrder).map(part => {
              ...
              const searchResults = isSearchOpen
                ...
                : []
              return (
                <div key={part.id} className="relative rounded-lg border border-stroke bg-surface p-2 flex flex-col gap-1.5">
                  ...
                  {/* Line 2: description + catalog search */}
                  <div className="flex items-center gap-2">
                    <input
                    ...
                    <button
                      ...
                      className={`shrink-0 px-2 py-1.5 rounded-lg border text-sm ${isSearchOpen ? 'border-brand-orange text-brand-orange bg-orange-50' : 'border-stroke text-ink-faint'}`}
                  ...
                  {isSearchOpen && (
                    <div className="absolute left-0 right-0 top-full z-20 mt-1 rounded-xl border border-stroke bg-white shadow-lg overflow-hidden">
                      <input
                        ...
                        onChange={event => setCatalogSearch({ partId: part.id, query: event.target.value })}
                          ...
                          {searchResults.map(c => (
                            <li key={c.partNumber}>
                              <button
                                ...
                                onClick={() => {
                                  updatePart(part.id, 'code', c.partNumber)
                                  updatePart(part.id, 'description', c.description)
          ...
          <div className="flex flex-col gap-2">
            ...
            {form.parts.filter(p => p.toOrder).map(part => {
              ...
              const searchResults = isSearchOpen
                ...
                : []
              return (
                <div key={part.id} className="relative rounded-lg border border-orange-200 bg-orange-50/30 p-2 flex flex-col gap-1.5">
                  {/* Line 1: code + qty + remove */}
                  <div className="flex items-center gap-2">
                    <input
                      placeholder="Artikelcode"
                  ...
                  {/* Line 2: description + urgent + catalog search */}
                  <div className="flex items-center gap-2">
                    <input
                      placeholder="Omschrijving"
                      value={part.description}
                    ...
                    <button
                      ...
                      className={`shrink-0 text-xs px-2 py-1.5 rounded-lg border font-bold ${
                        part.urgent
                          ? 'border-brand-red text-white bg-brand-red'
